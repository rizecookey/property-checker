...
public final class OneOfString extends SingleString implements OneOf {
        ...
        if (!is_type) {
          ...
          if ((str == null) || "null".equals(str)) {
            ...
            if (str.startsWith("[")) {
              ...
              String tempStr = Signatures.fieldDescriptorToBinaryName(str);
              str = tempStr;
            }
            if (PrintInvariants.dkconfig_static_const_infer) {
              PptTopLevel pptt = ppt.parent;
  ...
  private static String format_esc_string2type(String str) {
    ...
    if (str.startsWith("[")) {
      @SuppressWarnings("signature")
      String temp_type_str = Signatures.fieldDescriptorToBinaryName(str);
    ...
    for (int i = 0; i < num_elts; i++) {
      ...
      if (is_type) {
        if (value == null) {
          ...
          @SuppressWarnings("signature")
          String tempValue = Signatures.fieldDescriptorToBinaryName(value);
          value = tempValue;
